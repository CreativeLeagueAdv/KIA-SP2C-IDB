...
export default function LightsSection({ type }: { type: "Tail" | "Head" }) {
  ...
  const MaterialUISwitch = styled(Switch)(({ theme }) => ({
    ...
    "& .MuiSwitch-switchBase": {
      ...
      "&.Mui-checked": {
        ...
        "& + .MuiSwitch-track": {
          opacity: 1,
          backgroundColor: theme.palette.mode === "dark" ? "red" : "transparent",
        },
      },
    },
    "& .MuiSwitch-thumb": {
  ...
  return (
    <>
      <div id='mainColor' className={styles.colorsMainContainer} style={{height:'95vh'}}>
        <img
          alt='color'
          className={styles.mainImage}
          width={100}
          height={100}
          src={`/assets/${type}light${state}.webp`}
        />
        <div
          style={{
            position: "absolute",
          ...
          <div
            ...
            <FormControlLabel
              control={
                <MaterialUISwitch
                  sx={{ m: 1 }}
                  defaultChecked={state == "On" ? true : false}
                  onClick={() => {

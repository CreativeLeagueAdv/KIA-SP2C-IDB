...
function AppView () {
    ...
    return (
        <div style={{ position: 'relative' }}>
            <Typography sx={{ position: 'absolute', top: '60px', fontSize: { sm: '18px', xs: '18px', lg: '36px ', xl: '36px ' }, color: '#fff', zIndex: 1000, width: '100%', textAlign: 'center' }}>360VR Interior</Typography>
            <div id='pano360'>
